...
### Phase 1: Data Discovery (SELECT & FROM) <br>
- The "Full Audit": How do you display every single row and column from the Streaming_Data table?<br>
- The "Quick List": Write a query to show only the title, type, and genre for every entry in the table.<br>
- The "Quick Preview": Show only the first 5 rows from the table to see how the content is formatted.<br>
